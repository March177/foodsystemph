...
include 'insert_subcategory.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Call the function to insert subcategory
    $success = insertSubcategory($conn, $category_id, $subcategory_name, $description, $status);

    if ($success) {
        $message = "Subcategory added successfully.";
        $alert_class = "alert-success";
    } else {
        $message = "Error: Could not add subcategory.";
