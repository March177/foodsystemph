                ...
                cartItems.forEach((item, index) => {
                    ...
                    <div class="flex justify-between items-center border-b pb-4" data-id="${index}">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="text-lg font-semibold text-pink-700 item-total-price" data-id="${index}">₱${itemTotalPrice}</div>
                            <button class="text-gray-400 hover:text-red-500 delete-item flex items-center" data-id="${index}">
